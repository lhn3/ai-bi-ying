              ...
              return (
                <div className='footer-item' key={item.name}>
                  <div className='item-title'>{item.name}</div>
                  {
                    item.list.map(i => {
                      return (
                        <div className='item-info' key={i.name}>{i.name}{i.new ? <span>新推出</span> : null}</div>
                      )
                    })
                  }
                </div>
        ...
        <div className='footer-bottom'>
          <div className='svg'>
            <svg viewBox="0 0 1000 1000" role="presentation" aria-hidden="true" focusable="false"
                 style={styleStrToObj('height: 1.5em; width: 1.5em; display: block; fill: rgb(118, 118, 118);')}>
              <path
          ...
          <div className='icons'>
            <svg viewBox="0 0 32 32" role="img" aria-hidden="false" aria-label="前往微博" focusable="false"
                 style={styleStrToObj("height: 18px; width: 18px; display: block; fill: rgb(118, 118, 118);")}>
              <path
            ...
            <svg viewBox="0 0 32 32" role="presentation" aria-hidden="true" focusable="false"
                 style={styleStrToObj('height: 1em; width: 1em; display: block; fill: currentcolor;')}>
              <path
