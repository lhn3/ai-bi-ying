...
const HeaderCenterSearch = memo((props) => {
  return (
    <HeaderCenterSearchWrapper isTransparent={props.isTransparent} isFocus={props.isFocus} isFixed={props.isFixed}>
      <CSSTransition in={props.isFocus} timeout={300}  unmountOnExit={true} classNames='mySwitch3'>
        <div className='se-main'>
          ...
          <div className='se-box se-right'>
            ...
            <div className='se-icon'><IconSearchBar /></div>
          </div>
        </div>
      </CSSTransition>
